var textes = {
  fr: {
    ...
    egal: {
      mot: "Être égaux",
      original: "$égal, ale, aux$ @adj. et n.@ _1._ @(Personnes, choses)@ %Qui est de la même quantité, dimension, nature, qualité ou valeur.% _identique, même ; équivalent._ @/ contr.@ _inégal ; différent._ _2._ @(Personnes)@ %Qui es sur le même rang ; qui a les mêmes droits et charges% _pareil._",
    ...
    faire_peut: {
      mot: "Faire",
      original: "$faire$ @v. tr. . conjug.@ _1._ %Réaliser hors de soi (une chose matérielle).% *Faire une maison.* _bâtir, construire._ *Faire un meuble.* _fabriquer_ *Faire le pain.* _préparer_ *Faire une robe.* *>* _confectionner._ *Faire un tableau.* _créer._ _2._ %Réaliser (une chose abstraite).% *Faire une loi.* _instaurer, instituer._ *Faire une oeuvre.* _composer; créer._ *Faire un poème, une sonate.* _écrire._ ",
    ...
    fissurer: {
      mot: "Fissurer",
      original: "$fissurer$ @v. tr. . conjug.@ _1._ %Diviser par fissures.% _crevasser, fendre._",
    ...
    inverser: {
      mot: "Inverser",
      original: "$inverser$ @v. tr. . conjug.@ _1._ %Changer la position, l’ordre. >% _intervertir._ ",
    ...
    montagne: {
      mot: "Montagne",
      original: "$montagne$ @n.f.@ _1._ %Importante élévation du terrain.% _éminence, hauteur;mont._ _2._ @loc.@ %Métaphore qui désigne la famille comme étant ce qui occupe la plus grande partie de l'espace dans la maison et la vie, tout en étant aussi ce qu'il y a de plus beau.%",
      interpretation: "$montagne$ @n.f.@ _1._ %Importante élévation du terrain.% _éminence, hauteur;mont._ _2._ @loc.@ %Métaphore qui désigne la famille comme étant ce qui occupe la plus grande partie de l'espace dans la maison et la vie, tout en étant aussi ce qu'il y a de plus beau.%"
    },
    presence: {
      mot: "Présence",
      original: "$présence$ @n.f.@ _1._ %Le fait d'être physiquement quelque part auprès de qqn.% @/contr.@  _abscence._ _2._ %Disposition d'esprit qui permet d'avoir accès à l'amour envers les membres de sa famille, au delà du surmenage, des exigences de la vie quotidienne, des soucis ou de la cohabitation.%",
      interpretation: "$présence$ @n.f.@ _1._ %Le fait d'être physiquement quelque part auprès de qqn.% @/contr.@  _abscence._ _2._ %Disposition d'esprit qui permet d'avoir accès à l'amour envers les membres de sa famille, au delà du surmenage, des exigences de la vie quotidienne, des soucis ou de la cohabitation.%"
    },
    se_refugier: {
      mot: "Se réfugier",
